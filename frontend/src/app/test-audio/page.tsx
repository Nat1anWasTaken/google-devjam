  ...
  return (
    <div className="container mx-auto p-6 space-y-8">
      <div className="text-center space-y-2">
        ...
        <p className="text-muted-foreground">Test the audio player component with different audio sources</p>
      </div>
      ...
      <div className="space-y-6">
        {testAudios.map((audio) => (
          <div key={audio.id} className="space-y-2">
            ...
            <AudioPlayer audioUrl={audio.url} newsId={audio.id} className="max-w-md" />
          </div>
        ))}
      </div>
